...
import HeroBlog from "../../../components/Categories/components/HeroBlog"; '../../../components/Categories/components/HeroBlog'
            ...
            {/* <div>
                ...
                <ul>
                    {props.blogs.map((blog, idx) => {
                        return (
                            <li key={blog.id}>
                                <Link href={`/categories/${blog.cat}/${blog.slug}`}>
                                    <p style={{"marginTop": "300px"}}>{blog.title}</p>
                                </Link>
                            </li>
                        );
                    })}
